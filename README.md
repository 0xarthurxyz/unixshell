...
This is a cheat sheet for Unix shell commands (mostly notes-to-self). They are incomplete by
default.
...
> -   For Windows users, the [Gpg4win](https://www.gpg4win.org/) integrates with other Windows
>     tools.
